...
const Payment = (props) => {
    ...
    const paymentsOnly = payments.filter(item => item.ownerCard === cookies.get('cardIdentification') && item.payState === 'paid out')
    ...
    return ( 
        ...
        >
            ...
            <h1 style={{color:'black'}}>Payment's Paid Out</h1><br/>
