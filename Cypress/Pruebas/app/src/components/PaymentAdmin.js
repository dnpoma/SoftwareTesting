...
const Payment = (props) => {
    ...
    const paymentsOnly = payments.filter(item =>  item.paymentType !== "admin" && item.paymentUsername !== cookies.get('username'))
        ...
        { 
            ...
            renderCell: (params) => (
                ...
                >
                    ...
                    <EditPaymentAdmin data ={params.row} handleUpdateRegister= { habldeUpdateRegister } />
                </div>
            )
        }
    ]
    ...
    return ( 
        ...
        >
            ...
            <h1 style={{color:'black'}}>Payment's Data</h1><br/>
            ...
            <Button sx={{ bgcolor: green[500], height: '50px', width: '150px', color: 'black'}} onClick = {OnclickInsertar} >Add Payment</Button><br></br> 
            <div style={{ height: 400, width: '100%' }}>
                <DataGrid
                    rows=
                    {
                        paymentsaux.map(item => (
                            {
                                id: item.id,
