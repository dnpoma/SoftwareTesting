...
import MatEditLocal from './EditPayment'
...
const Payment = (props) => {
    ...
    const paymentsOnly = payments.filter(item => item.ownerCard === cookies.get('cardIdentification') && item.payState === 'processing')
    ...
    return ( 
        ...
        >
            ...
            <h1 style={{color:'black'}}>Payment in Process</h1><br/>
