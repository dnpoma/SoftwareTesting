...
let EventsRepository = class EventsRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Events, dataSource);
    }
};
EventsRepository = (0, tslib_1.__decorate)([
